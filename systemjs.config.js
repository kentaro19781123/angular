...
var  map = {
	...
	'app2': 'app2', // パッケージ名：フォルダ名
	'app3': 'app3', // パッケージ名：フォルダ名
	'form': 'form', // パッケージ名：フォルダ名
...
var packages = {
	...
	'app2': { main: 'main.ts',  defaultExtension: 'ts' },
	'app3': { main: 'main.ts',  defaultExtension: 'ts' },
	'form': { main: 'main.ts',  defaultExtension: 'ts' },
